...
# Функция для отправки сообщения с изображением Мегумин
...
# Обработчик команды /howtoblowup
...
# Обработчик команды /aboutexplousion
...
# Функция для отправки изображения с грустной Мегумин
...
# Словарь для хранения информации о времени последнего использования команды /explode
last_explode_time = {}

# Функция для проверки возможности использования команды /explode
...
# Словарь для хранения информации о количестве взрывов для каждого пользователя
explosions_count = {}
...
# Функция для получения случайной гифки из серии "Konosuba"
...
# Функция для получения случайной гифки с аниме
